...
def train_eval(X_train, X_test, y_train, y_test, result_save_path):
...
def biomarker_select(gene_GSE_concated_train, gene_GSE_concated_test, label_GSE_concated_train, label_GSE_concated_test, label_selected="control", path_data_prepared="data_prepared/test/", result_path = "results/test/2categories/", local_time=0):
    """
