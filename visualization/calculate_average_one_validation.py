import pandas as pd
import glob
num_of_model_result_in_one_file = 4
...
source_folder = "../results/final_model_results/20210512_1/predict_onall_exclude2_6269_1_raw639900.7_validation/2*.csv"
final_average_csv_path = "../results/final_model_results/20210512_1/predict_onall_exclude2_6269_1_raw639900.7_validation/train_0512_1_average.csv"

# source_folder = "../results/final_model_results/20210512_1/predict_onall_exclude2_6269_1_raw639900.3_validation/2*.csv"
# final_average_csv_path = "../results/final_model_results/20210512_1/predict_onall_exclude2_6269_1_raw639900.3_validation/test_0512_1_average.csv"

# source_folder = "../results/final_model_results/20210512_1/predict_ononly_21802_57065None_validation/2*.csv"
# final_average_csv_path = "../results/final_model_results/20210512_1/predict_ononly_21802_57065None_validation/val_0512_1_average.csv"
...
for final_result_list_each in final_result_list:
    ...
    if final_each_pd.shape[0] == num_of_model_result_in_one_file:
        print(final_result_list_each)
